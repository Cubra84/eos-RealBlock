                    ...
                    <div class="container">
                        ...
                        <div class="user-area">
                            ...
                            <div class="language-bar">
                                <a href="index-slider.html#" class="active"><img src="assets/img/flags/gb.png" alt=""></a>
                                <a href="index-slider.html#"><img src="assets/img/flags/de.png" alt=""></a>
                                <a href="index-slider.html#"><img src="assets/img/flags/es.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <header class="navbar" id="top" role="banner">
                        ...
                        <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                            <ul class="nav navbar-nav">
                                <li class="active has-child"><a href="index-slider.html#">Homepage</a>
                                ...
                                <li class="has-child"><a href="index-slider.html#">Properties</a>
                                    <ul class="child-navigation">
                                ...
                                <li class="has-child"><a href="index-slider.html#">Pages</a>
                                    <ul class="child-navigation">
                                        ...
                                        <li class="has-child"><a href="index-slider.html#">Error Pages</a>
                                            <ul class="child-navigation">
                                ...
                                <li class="has-child"><a href="index-slider.html#">Agents & Agencies</a>
                                    <ul class="child-navigation">
                                ...
                                <li class="has-child"><a href="index-slider.html#">Blog</a>
                                    <ul class="child-navigation">
